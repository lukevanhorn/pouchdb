...
function bulkGet(db, opts, callback) {
  ...
  Object.keys(requestsById).forEach(function (docId, i) {
    ...
    //set the atts_since array to the same values in open_revs.   
    //This will result in only attachments *since* the specified revision to be included.
    //atts_since will override attachments, which would normally return all attachments
    docOpts.atts_since = docOpts.open_revs;
